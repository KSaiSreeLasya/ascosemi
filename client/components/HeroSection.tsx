...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-dark-bg via-background to-card-bg">
      {/* Background Pattern */}
      <div
        className={
      ...
      <div className="absolute inset-0">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-tech-blue rounded-full animate-float opacity-30"
            style={{
          ...
          <div className="text-center">
            ...
            >
              <div className="flex justify-center">
                <Link
                  to="/get-started"
                  className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-lg text-lg transition-all duration-200 hover:scale-105 flex items-center gap-2 group"
                >
                  Get Started
